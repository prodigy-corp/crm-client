...
const createFormSchema = () =>
  z.object({
    pin: z
      ...
      .regex(/^[A-Za-z0-9]+$/, { message: "OTP must be alphanumeric" }),
  });
        ...
        >
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription className="text-sm text-gray-500">
                  {maskedEmail
                    ? "Enter the 2FA OTP sent to your email"
                    : "Enter the 2FA OTP sent to your phone number"}
                </FormDescription>
                <FormMessage />
              </FormItem>
            )}
          ...
          <div className="flex items-center gap-3">
            ...
            <Button
              ...
              disabled={!canResend}
              className="w-full border-primary text-primary hover:bg-primary/5 disabled:opacity-60"
            >
