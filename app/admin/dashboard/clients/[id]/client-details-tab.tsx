        ...
        <div className="grid gap-6 md:grid-cols-2">
            ...
            <Card className="p-6">
                ...
                <div className="space-y-4 text-sm">
                    ...
                    {(client.address || client.city || client.country) && (
                        <div className="flex items-start gap-3">
                            <LuMapPin className="mt-0.5 h-4 w-4 text-muted-foreground" />
                            <div className="flex-1">
            ...
            <Card className="p-6">
                ...
                <div className="space-y-4 text-sm">
                    {client.companyName && (
                        <div className="flex items-start gap-3">
                            <LuBriefcase className="mt-0.5 h-4 w-4 text-muted-foreground" />
                            <div className="flex-1">
                    ...
                    {client.website && (
                        <div className="flex items-start gap-3">
                            <LuGlobe className="mt-0.5 h-4 w-4 text-muted-foreground" />
                            <div className="flex-1">
                    ...
                    {client.taxId && (
                        <div className="flex items-start gap-3">
                            <LuFileText className="mt-0.5 h-4 w-4 text-muted-foreground" />
                            <div className="flex-1">
                ...
                <div className="space-y-4 text-sm">
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                            ...
                            <p className={`font-medium ${client.outstandingBalance > 0 ? "text-destructive" : "text-green-600"}`}>
