...
import { useEmployeeProfile, useUpdateEmployeeProfile, useUploadEmployeePhoto } from "@/hooks/use-employee";
...
export default function ProfilePage() {
    ...
    const { data: profile, isLoading: profileLoading } = useEmployeeProfile({ enabled: !!user && isEmployeeUser });
                        ...
                        <div className="grid gap-4 md:grid-cols-2">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex items-center gap-2 rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 dark:border-gray-700 dark:bg-gray-800">
                                    ...
                                    <span className="text-sm">{user?.roles?.join(", ") || "N/A"}</span>
                                </div>
                            </div>
                        </div>
                    </CardContent>
                        ...
                        <div className="grid gap-4 md:grid-cols-2">
                            ...
                            <div className="space-y-2">
                                ...
                                {isEditing ? (
                                    ...
                                    <div className="flex items-center gap-2 rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 dark:border-gray-700 dark:bg-gray-800">
                                        ...
                                        <span className="text-sm">{employee?.mobileNumber || "N/A"}</span>
                                    </div>
                                )}
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                {isEditing ? (
                                    <Input
                                        ...
                                        onChange={(e) =>
                                            setFormData({ ...formData, alternativeContactNumber: e.target.value })
                                        }
                                    />
                                ) : (
                                    <div className="flex items-center gap-2 rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 dark:border-gray-700 dark:bg-gray-800">
                                        <LuPhone className="h-4 w-4 text-gray-500" />
                                        <span className="text-sm">{employee?.alternativeContactNumber || "N/A"}</span>
                                    </div>
                                )}
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                {isEditing ? (
                                    ...
                                    <div className="flex items-center gap-2 rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 dark:border-gray-700 dark:bg-gray-800">
                                        <LuPhone className="h-4 w-4 text-gray-500" />
                                        <span className="text-sm">{employee?.emergencyContactNumber || "N/A"}</span>
                                    </div>
                                )}
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                {isEditing ? (
                                    <Input
                                        ...
                                        onChange={(e) =>
                                            setFormData({ ...formData, facebookProfileLink: e.target.value })
                                        }
                                    />
                                ) : (
                                    <div className="flex items-center gap-2 rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 dark:border-gray-700 dark:bg-gray-800">
                                        <LuUser className="h-4 w-4 text-gray-500" />
                                        <span className="text-sm break-all">{employee?.facebookProfileLink || "N/A"}</span>
                                    </div>
                                )}
                            </div>
                        </div>
