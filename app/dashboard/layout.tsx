...
export default function DashboardLayout({
    ...
    return (
        <div className="flex h-screen bg-gray-100 dark:bg-gray-900">
            {/* Sidebar - Desktop */}
            <aside className="hidden w-64 flex-col bg-white shadow-md dark:bg-gray-800 lg:flex">
            ...
            {sidebarOpen && (
                <div className="fixed inset-0 z-50 lg:hidden">
                    ...
                    />
                    <aside className="absolute left-0 top-0 h-full w-64 bg-white shadow-lg dark:bg-gray-800">
                        <div className="flex h-full flex-col">
                            {/* Mobile Header */}
