...
import { usePermissions, useRole, useUpdateRole } from "@/hooks/use-admin";
                              ...
                              <Button
                                ...
                                onClick={(e) => {
                                  ...
                                  if (allSelected) {
                                    ...
                                    const groupNames = groupPerms.map(
                                      (p: any) =>
                                        typeof p === "object" ? p.name : p,
                                    );
                                    setSelectedPermissions((prev) =>
                        ...
                        rolePermissions.reduce(
                          (acc: Record<string, string[]>, perm: string) => {
                            const permObj = permissions?.find(
                              (p: any) =>
                                (typeof p === "object" ? p.name : p) === perm,
                            );
                            const group =
                              permObj && typeof permObj === "object"
