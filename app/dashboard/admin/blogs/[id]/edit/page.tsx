...
const blogSchema = yup.object({
  ...
  metaTitle: yup
    .string()
    .max(70, "Meta title should be max 70 characters")
    .optional(),
  metaDescription: yup
    .string()
  ...
  status: yup
    .string()
    .oneOf(["DRAFT", "PUBLISHED", "SCHEDULED", "ARCHIVED"])
    .optional(),
      ...
      {updateBlogMutation.isError && (
        <div className="rounded-lg border border-destructive bg-destructive/10 p-4">
          <p className="text-sm font-medium text-destructive">
            Error:{" "}
            {(updateBlogMutation.error as any)?.message ||
        ...
        {activeTab === "settings" && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Configure additional blog post options
              </CardDescription>
            </CardHeader>
