...
export const employeeApi = {
  ...
  uploadPhoto: (file: File) => {
    ...
    return apiClient.post<
      ApiResponse<{ id: string; photoUrl: string; key: string }>
    >("/employee/profile/photo", formData, {
      headers: {
  ...
  getAttendance: (params?: {
    ...
    apiClient.get<ApiResponse<PaginatedResponse<EmployeeAttendance>>>(
      "/employee/attendance",
      { params },
    ),

  getTodayAttendance: () =>
    apiClient.get<ApiResponse<EmployeeAttendance | null>>(
      "/employee/attendance/today",
    ),

  getAttendanceStatistics: () =>
    apiClient.get<ApiResponse<AttendanceStatistics>>(
      "/employee/attendance/statistics",
    ),

  checkIn: (date?: string) =>
    apiClient.post<ApiResponse<EmployeeAttendance>>(
  ...
  getSalaryPayments: (params?: {
    ...
    apiClient.get<PaginatedResponse<EmployeeSalaryPayment>>(
      "/employee/salary/payments",
      { params },
    ),

  getSalaryIncrements: () =>
    apiClient.get<ApiResponse<EmployeeSalaryIncrement[]>>(
