...
export const useEmployeeAttendance = (params?: {
    ...
    return useQuery({
        ...
        queryFn: () => employeeApi.getAttendance(params).then((res) => res.data),
    });
};
...
export const useAttendanceStatistics = () => {
    return useQuery({
        ...
        queryFn: () => employeeApi.getAttendanceStatistics().then((res) => res.data),
    });
};
...
export const useEmployeeSalaryPayments = (params?: {
    ...
    return useQuery({
        ...
        queryFn: () => employeeApi.getSalaryPayments(params).then((res) => res.data),
    });
};
